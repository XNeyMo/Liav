...
const Accessories = () => {
	const products = useFetchProducts('Accessories');
	...
	return (
		<section className='px-10'>
			<h1 className='text-5xl font-bold py-5 text-center'>ACCESSORIES</h1>
			...
			<div className='flex gap-4'>
					...
					<p>No products found in the "Accessories" category.</p>
				)}
			</div>
